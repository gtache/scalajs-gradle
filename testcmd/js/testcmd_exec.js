...
$c_LTest$.prototype.square__I__I = (function(x) {
  return $imul(x, x)
});
$c_LTest$.prototype.$$js$exported$meth$square__I__O = (function(x) {
  return this.square__I__I(x)
});
$c_LTest$.prototype.main__V = (function() {
  var squared = this.square__I__I(10);
  var x = ("Hello ! Square of 10 is " + squared);
...
$c_LTest$.prototype.square = (function(arg$1) {
  var prep0 = $uI(arg$1);
  return this.$$js$exported$meth$square__I__O(prep0)
});
...
$c_LTest2$.prototype = new $h_O();
$c_LTest2$.prototype.constructor = $c_LTest2$;
/** @constructor */
function $h_LTest2$() {
  /*<skip>*/
}
$h_LTest2$.prototype = $c_LTest2$.prototype;
$c_LTest2$.prototype.init___ = (function() {
  return this
});
$c_LTest2$.prototype.square__I__I = (function(x) {
  return $imul(x, x)
});
$c_LTest2$.prototype.$$js$exported$meth$square__I__O = (function(x) {
  return this.square__I__I(x)
});
$c_LTest2$.prototype.main__V = (function() {
  var squared = this.square__I__I(3);
  var x = ("Hello ! Square of 10 is " + squared);
  var this$2 = $m_s_Console$();
  var this$3 = $as_Ljava_io_PrintStream(this$2.outVar$2.v$1);
  this$3.java$lang$JSConsoleBasedPrintStream$$printString__T__V((x + "\n"))
});
$c_LTest2$.prototype.$$js$exported$meth$main__O = (function() {
  this.main__V()
});
$c_LTest2$.prototype.main = (function() {
  return this.$$js$exported$meth$main__O()
});
$c_LTest2$.prototype.square = (function(arg$1) {
  var prep0 = $uI(arg$1);
  return this.$$js$exported$meth$square__I__O(prep0)
});
var $d_LTest2$ = new $TypeData().initClass({
  LTest2$: 0
}, false, "Test2$", {
  LTest2$: 1,
  O: 1,
...
$c_LTest2$.prototype.$classData = $d_LTest2$;
var $n_LTest2$ = (void 0);
function $m_LTest2$() {
  if ((!$n_LTest2$)) {
    $n_LTest2$ = new $c_LTest2$().init___()
  };
  return $n_LTest2$
}
$e.Test2 = $m_LTest2$;
